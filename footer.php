...
<!-- wordpress footer function -->
    ...
    <script src="<?php bloginfo('stylesheet_directory'); ?>/vendor/bootstrap/js/bootstrap.min.js"></script>
    ...
    <!-- Theme JavaScript -->
    <script src="<?php bloginfo('stylesheet_directory'); ?>/js/agency.min.js"></script>
